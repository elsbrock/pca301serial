...
// 2014-05-05 set command for center frequency implemented in: uint8_t rf12_initialize(void)
//
...
uint8_t rf12_initialize(void) {
  ...
  // rf12_xfer(0xA6FE);               // Frequency    - 868.9500MHz
  rf12_xfer(rf12_center_freq);        // Frequency    - rf12_center_freq
